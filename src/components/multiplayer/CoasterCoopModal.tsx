...
import { createInitialGameState } from '@/context/CoasterContext';
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-md bg-slate-900 border-slate-700 text-white" aria-describedby={undefined}>
          ...
          <div className="flex flex-col items-center justify-center py-8">
            ...
            <T><p className="text-slate-500 text-sm mt-1">Waiting for park state</p></T>
          </div>
        </DialogContent>
      </Dialog>
    );
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-md bg-slate-900 border-slate-700 text-white">
          <DialogHeader>
            ...
            <DialogDescription className="text-slate-400">
              <T>Build a park together with friends in real-time</T>
            </DialogDescription>
          </DialogHeader>
        ...
        <div className="flex flex-col gap-4 mt-4">
          ...
          {waitingForState && (
            <div className="bg-slate-800/50 rounded-lg p-4 text-center">
              ...
              <T><p className="text-slate-500 text-xs mt-1">Waiting for park state</p></T>
            </div>
          )}
