...
import { T, Var, Currency, Branch, useGT } from 'gt-next';
      ...
      <Card className="bg-card/95 border-border/70 shadow-xl">
        ...
        <div className="p-4 space-y-4 text-sm">
          ...
          <T>
            <Branch
              branch={ride.status}
              open={<Button className="w-full" variant="outline" onClick={onToggleStatus}>Close Ride</Button>}
            >
              <Button className="w-full" variant="default" onClick={onToggleStatus}>Open Ride</Button>
            </Branch>
          </T>
        </div>
      </Card>
