...
export default function ResearchPanel({
  ...
  const getButtonLabel = (item: Research['items'][0], isActive: boolean) => {
    if (item.unlocked) return gt('Unlocked');
    if (isActive) return gt('Active');
    return gt('Research');
  };
