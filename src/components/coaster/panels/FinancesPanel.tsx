  ...
  return (
    <Card className="fixed top-16 right-4 w-80 max-h-[calc(100vh-5rem)] bg-slate-900/95 border-white/10 z-50 flex flex-col">
      <div className="flex items-center justify-between p-4 border-b border-white/10">
        <T><h2 className="text-white font-bold">Finances</h2></T>
        <Button
          variant="ghost"
          size="icon"
      ...
      <ScrollArea className="flex-1 p-4">
        ...
        <div className="space-y-3">
          <div className="p-3 bg-white/5 rounded-lg">
            <div className="flex justify-between items-center">
              <T><span className="text-white/60">Cash</span></T>
          ...
          <div className="p-3 bg-white/5 rounded-lg">
            <div className="flex justify-between items-center mb-2">
              <T><span className="text-white/60">Loan</span></T>
        ...
        {/* This Month */}
        <div className="mt-6">
          <T><h3 className="text-white/50 text-xs uppercase tracking-wider mb-3">This Month</h3></T>

          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              <T><span className="text-white/60">Park Entrance</span></T>
              <span className="text-green-400">{formatMoney(record.parkEntranceFees)}</span>
            </div>
            <div className="flex justify-between text-sm">
              <T><span className="text-white/60">Ride Tickets</span></T>
              <span className="text-green-400">{formatMoney(record.rideTickets)}</span>
            </div>
            <div className="flex justify-between text-sm">
              <T><span className="text-white/60">Shop Sales</span></T>
            ...
            <div className="flex justify-between text-sm">
              <T><span className="text-white/60">Staff Wages</span></T>
              <span className="text-red-400">-{formatMoney(record.staffWages)}</span>
            </div>
            <div className="flex justify-between text-sm">
              <T><span className="text-white/60">Ride Running</span></T>
              <span className="text-red-400">-{formatMoney(record.rideRunning)}</span>
            </div>
            <div className="flex justify-between text-sm">
              <T><span className="text-white/60">Construction</span></T>
        ...
        <div className="mt-6 p-3 bg-white/5 rounded-lg">
          <div className="flex justify-between items-center">
            <T><span className="text-white/60">Park Value</span></T>
            <span className="font-mono text-purple-400">
              {formatMoney(finances.parkValue)}
            </span>
          </div>
          <div className="flex justify-between items-center mt-1">
            <T><span className="text-white/60">Company Value</span></T>
            <span className="font-mono text-purple-400">
