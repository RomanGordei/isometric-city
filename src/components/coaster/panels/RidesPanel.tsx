  ...
  return (
    <Card className="fixed top-16 right-4 w-80 max-h-[calc(100vh-5rem)] bg-slate-900/95 border-white/10 z-50 flex flex-col">
      <div className="flex items-center justify-between p-4 border-b border-white/10">
        <T><h2 className="text-white font-bold">Rides</h2></T>
        <Button
          variant="ghost"
          size="icon"
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <T><p className="text-white/50 text-xs">per ride</p></T>
                  </div>
                </div>

                <div className="mt-3 grid grid-cols-3 gap-2 text-xs">
                  <div className="text-center">
                    <T><p className="text-white/50">Queue</p></T>
                    <p className="text-white font-medium">{ride.queueLength}</p>
                  </div>
                  <div className="text-center">
                    <T><p className="text-white/50">Riders</p></T>
                    <p className="text-white font-medium">{ride.totalRiders}</p>
                  </div>
                  <div className="text-center">
                    <T><p className="text-white/50">Revenue</p></T>
