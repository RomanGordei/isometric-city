        ...
        <div className="p-4 space-y-4 text-sm">
          <T>
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold"><Currency value={cash} currency="USD" /></span>
            </div>
          </T>
          <div className="space-y-2">
            ...
            <T>
              <div className="flex items-center justify-between">
                ...
                <span><Currency value={entranceRevenue} currency="USD" /></span>
              </div>
            </T>
            <div className="space-y-1">
              <T>
                <div className="flex items-center justify-between text-xs text-muted-foreground">
                  ...
                  <span><Currency value={entranceFee} currency="USD" /></span>
                </div>
              </T>
              <Slider
                value={[entranceFee]}
            ...
            <T>
              <div className="flex items-center justify-between">
                ...
                <span><Currency value={rideRevenue} currency="USD" /></span>
              </div>
            </T>
            <T>
              <div className="flex items-center justify-between">
                <span>Shops & Stalls</span>
                <span><Currency value={shopRevenue} currency="USD" /></span>
              </div>
            </T>
            <T>
              <div className="flex items-center justify-between font-semibold">
                <span>Total Income</span>
                <span><Currency value={income} currency="USD" /></span>
              </div>
            </T>
          </div>
          <div className="space-y-2">
            ...
            <T>
              <div className="flex items-center justify-between">
                ...
                <span><Currency value={staffCost} currency="USD" /></span>
              </div>
            </T>
            <T>
              <div className="flex items-center justify-between">
                <span>Maintenance</span>
                <span><Currency value={maintenanceCost} currency="USD" /></span>
              </div>
            </T>
            <T>
              <div className="flex items-center justify-between">
                <span>Research</span>
                <span><Currency value={researchCost} currency="USD" /></span>
              </div>
            </T>
            <T>
              <div className="flex items-center justify-between">
                <span>Loan Interest</span>
                <span><Currency value={loanInterestCost} currency="USD" /></span>
              </div>
            </T>
            <T>
              <div className="flex items-center justify-between font-semibold">
                <span>Total Expenses</span>
                <span><Currency value={expenses} currency="USD" /></span>
              </div>
            </T>
          </div>
          <T>
            <div className="flex items-center justify-between">
              ...
              <span><Currency value={loan} currency="USD" /></span>
            </div>
          </T>
          <div className="space-y-2">
            ...
            <T>
              <div className="flex items-center justify-between text-xs text-muted-foreground">
                ...
                <span><Currency value={loanAmount} currency="USD" /></span>
              </div>
            </T>
            <Slider
              value={[loanAmount]}
