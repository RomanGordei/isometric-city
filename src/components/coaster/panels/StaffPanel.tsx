...
import { T, Var, Branch, Currency, useGT, useMessages } from 'gt-next';
            ...
            {STAFF_DEFINITIONS.map((definition) => (
              ...
              >
                <div>
                  ...
                  <T>
                    <div className="text-[10px] text-muted-foreground"><Currency currency="USD">{definition.hiringFee}</Currency> hire</div>
                  </T>
                </div>
              </Button>
            ))}
                  ...
                  <div>
                    ...
                    <T>
                      <div className="text-xs text-muted-foreground capitalize">
                        <Var>{member.type}</Var> · <Branch branch={Boolean(member.patrolArea).toString()} true={<>Patrol area</>} false={<>Park-wide</>} />
                      </div>
                    </T>
                  </div>
