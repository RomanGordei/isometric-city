...
// Generate initial game state for a new park
function createInitialGameState(parkName: string): GameState {
  // This will be provided by the parent component or we'll use a minimal state
  // The actual creation is done in the CoasterContext
  return {
    id: `park-${Date.now()}`,
    grid: [],
    gridSize: 60,
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-md bg-emerald-950 border-emerald-800 text-white">
          <DialogHeader>
            ...
            <DialogDescription className="text-emerald-400/70">
