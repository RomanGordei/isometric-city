...
// Mobile: much lower limits for performance on large cities
...
export const PEDESTRIAN_SPAWN_BATCH_SIZE_MOBILE = 5;
export const PEDESTRIAN_SPAWN_INTERVAL = 0.03;      // Seconds between spawn batches
export const PEDESTRIAN_SPAWN_INTERVAL_MOBILE = 0.15;
