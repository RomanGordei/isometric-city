...
import { Pedestrian, PedestrianDestType, WorldRenderState } from '../types';
import { PEDESTRIAN_SKIN_COLORS, PEDESTRIAN_SHIRT_COLORS, PEDESTRIAN_MIN_ZOOM } from '../constants';
import { isRoadTile, findPathOnRoads, getDirectionToTile, CarDirection } from '../utils';
...
export function usePedestrians(
  ...
  }, [spawnPedestrian, worldStateRef, gridVersionRef, cachedRoadTileCountRef, isMobile]);
