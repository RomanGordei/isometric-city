...
import { isRoadTile, getDirectionOptions, pickNextDirection } from '../utils';

export function useCars(worldStateRef: React.MutableRefObject<WorldRenderState>, isMobile: boolean) {
  ...
  }, [spawnRandomCar, worldStateRef, isMobile]);
