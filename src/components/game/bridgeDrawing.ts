...
// ============================================================================
// Main Bridge Drawing Functions
// Extracted from CanvasIsometricGrid.tsx for better maintainability
// ============================================================================

/**
 * Draw a complete bridge tile with all details
 * Handles road bridges, rail bridges, and all bridge types (small, medium, large, suspension)
 */
...
export function drawSuspensionBridgeOverlay(
  ...
  // Extended points for cable anchors (simulated anchor points beyond tile)
  const travelDirX = dx / travelLen;
  const travelDirY = dy / travelLen;
  
  // Calculate cable attachment points on deck barriers
  const cableAttachLeft = {
    startX: startLeft.x - travelDirX * cableExtension,
    startY: startLeft.y - travelDirY * cableExtension - barrierOffset,
    endX: endLeft.x + travelDirX * cableExtension,
    endY: endLeft.y + travelDirY * cableExtension - barrierOffset,
  };
  const cableAttachRight = {
    startX: startRight.x - travelDirX * cableExtension,
    startY: startRight.y - travelDirY * cableExtension - barrierOffset,
    endX: endRight.x + travelDirX * cableExtension,
    endY: endRight.y + travelDirY * cableExtension - barrierOffset,
  };
