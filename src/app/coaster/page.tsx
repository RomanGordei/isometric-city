  ...
  if (isMobile) {
    return (
      <main className="h-[100dvh] max-h-[100dvh] bg-gradient-to-br from-emerald-950 via-teal-950 to-emerald-950 flex flex-col items-center px-4 pt-[max(1rem,env(safe-area-inset-top))] pb-[max(1rem,env(safe-area-inset-bottom))] overflow-y-auto">
        ...
        <h1 className="text-4xl sm:text-5xl font-light tracking-wider text-white/90 mb-4 sm:mb-6 text-center break-words max-w-full">
          IsoCoaster
        </h1>
        ...
        {savedParks.length > 0 && (
          <div className="w-full max-w-xs mt-3 sm:mt-4 flex-1 min-h-0 flex flex-col">
            ...
            <div className="flex flex-col gap-2 flex-1 overflow-y-auto overscroll-y-contain" style={{ WebkitOverflowScrolling: 'touch', touchAction: 'pan-y' }}>
