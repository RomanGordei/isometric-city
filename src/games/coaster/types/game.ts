...
export const TOOL_INFO: Record<Tool, ToolInfo> = {
  ...
  coaster_banked_turn_left: { name: 'Track: Banked Left', cost: 35, description: 'Place a banked left turn (tilted for high speed)', category: 'coasters' },
  coaster_banked_turn_right: { name: 'Track: Banked Right', cost: 35, description: 'Place a banked right turn (tilted for high speed)', category: 'coasters' },
