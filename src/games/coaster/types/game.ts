...
export const TOOL_INFO: Record<Tool, ToolInfo> = {
  ...
  coaster_turn_banked_left: { name: 'Track: Banked Left', cost: 30, description: 'Place a left turn with banking', category: 'coasters' },
  coaster_turn_banked_right: { name: 'Track: Banked Right', cost: 30, description: 'Place a right turn with banking', category: 'coasters' },
