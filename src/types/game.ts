...
export const TOOL_INFO: Record<Tool, ToolInfo> = {
  ...
  rail: { name: 'Rail', cost: 35, description: 'Lay tracks for trains' },
  ...
  rail_station: { name: 'Rail Station', cost: 900, description: 'Provides access to surface rail', size: 1 },
...
export const BUILDING_STATS: Record<BuildingType, { maxPop: number; maxJobs: number; pollution: number; landValue: number }> = {
  ...
  rail_station: { maxPop: 0, maxJobs: 18, pollution: 0, landValue: 28 },
