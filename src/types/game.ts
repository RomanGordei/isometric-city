...
export const TOOL_INFO: Record<Tool, ToolInfo> = {
  ...
  rail: { name: 'Rail', cost: 40, description: 'Lay twin tracks for trains' },
  ...
  rail_station: { name: 'Rail Station', cost: 900, description: 'Passenger access to surface rail', size: 1 },
...
export const BUILDING_STATS: Record<BuildingType, { maxPop: number; maxJobs: number; pollution: number; landValue: number }> = {
  ...
  rail_station: { maxPop: 0, maxJobs: 20, pollution: 1, landValue: 18 },
