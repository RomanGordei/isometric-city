...
// =============================================================================
// TERRAIN GENERATION - Perlin noise for natural lake generation
// =============================================================================
...
// Generate 2-3 large, round lakes for park terrain
...
function createInitialGameState(parkName: string = 'My Theme Park', gridSize: number = DEFAULT_GRID_SIZE): GameState {
  ...
  // Generate natural-looking lakes using Perlin noise (same as IsoCity)
